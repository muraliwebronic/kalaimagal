      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <BiLabel ta={strings.nav.login.ta} en={strings.nav.login.en} variant="inline" englishHidden />
          </Link>
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="w-[85%] max-w-sm">
              <SheetHeader>
                <SheetTitle>
                  <span lang="ta" className="font-heading text-2xl text-primary">
                    {strings.brand.name.ta}
                  </span>
                </SheetTitle>
                <SheetDescription>{strings.brand.tagline.en}</SheetDescription>
              </SheetHeader>
